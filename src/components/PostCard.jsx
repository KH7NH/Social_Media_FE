...
const PostCard = ({ post }) => {
    ...
    return (
        <div className=" bg-white shadow rounded-xl p-4 space-y-4 w-full max-w-2xl">
            {/* User info */}
            ...
            <div className="flex items-center gap-4 text-gray-600 text-sm pt-2 border-t border-gray-300">
                <div className="flex items-center gap-1">
                    <Heart className={`w-4 h-4 cursor-pointer hover:text-red-500 ${likes.includes(currentUser._id) && 'text-red-500 fill-red-500'}`} onClick={handleLike} />
