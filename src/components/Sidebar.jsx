    ...
    <div
     ...
     justify-between items-center max-sm:absolute top-0 bottom-0 z-20 $
      ...
      <div className='w-full'>
        <img onClick={() => navigate('/')} src={assets.logo1} className='w-26 ml-7 my-2 cursor-pointer' />
        <hr className='border-gray-300 mb-8' />

        <MenuItems setSidebarOpen={setSidebarOpen} />
        <Link to='/create-post'
          className='flex items-center justify-center gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-gradient-to-r from-[oklch(55.6%_0_0)] to-[oklch(14.1%_0.005_285.823)]
