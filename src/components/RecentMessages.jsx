...
const RecentMessages = () => {
    ...
    return (
        <div className="bg-white max-w-xs mt-4 p-4 min-h-20  shadow rounded-md text-xs text-slate-800">
                        ...
                        <Link to={`/messages/${message.from_user_id._id}`} key={index} className="flex items-start gap-2 py-2 hover:bg-slate-100">
                            ...
                            <div className="w-full">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    {!message.seen && <p className="bg-[oklch(14.1%_0.005_285.823)] text-white w-4 h-4 flex items-center justify-center rounded-full text-[10px]">1</p>}
                                </div>
                            </div>
